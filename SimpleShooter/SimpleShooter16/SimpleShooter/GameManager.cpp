...
//    sprShip = al_load_bitmap("..\\ship1.bmp");
//    sprShip = al_load_bitmap("..\\ship1.png");
    sprShip = al_load_bitmap("..\\ship1.pcx");
    oldSchoolTransparency(sprShip);
    
    sprEnemy_01 = al_load_bitmap("..\\enemy_alpha_l1_1.bmp");
    oldSchoolTransparency(sprEnemy_01);

    sprEnemy_02 = al_load_bitmap("..\\enemy_alpha_l1_2.bmp");
    oldSchoolTransparency(sprEnemy_02);

    sprBullet = al_load_bitmap("..\\bullet1.bmp");
    oldSchoolTransparency(sprBullet);
...
void GameManager::Draw() {
    al_clear_to_color(al_map_rgb(32, 0, 0));
    ...
    al_draw_text(myfont, al_map_rgb(0, 255, 0), 32, 32, 0, "Step 16 - Add sprite images");
    /*
    if (strDebugStick != "") {
